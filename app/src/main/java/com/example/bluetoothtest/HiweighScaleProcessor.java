...
public class HiweighScaleProcessor {
    ...
    private static final String TAG = "HiweighScaleProcessor";
...
//    private static final int expectedPayloadSize = 1024;

    public ScaleReading constructReading(byte[] payload) throws HiweighScaleException {

        Log.d(TAG, "constructReading: payload : " + payload);
        Log.d(TAG, "constructReading: payload.length : " + payload.length);
...
//        }
        ...
        Log.d(TAG, "constructReading: weightString : " + weightString);
        double weight;
        try {
